...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(CompareController::class)->group(function () {
        ...
        Route::get('/compare/clear', 'clear_compare')->name('user.compare.clear');
    ...
    Route::controller(CheckoutController::class)->group(function () {
        ...
        Route::get('/order/invoice/{uuid}', [CheckoutController::class, 'invoice'])->name('user.order.invoice');
        Route::get('/order/invoice/{uuid}/pdf', [CheckoutController::class, 'downloadInvoicePDF'])->name('user.order.invoice.pdf');
        ...
        Route::get('/midtrans', [CheckoutController::class, 'redirectToMidtrans'])->name('user.midtrans.view');
        Route::post('/generate-snap-token', [CheckoutController::class, 'checkoutMidtrans'])->name('user.generate.snap.token');
        Route::post('/order/complete', [CheckoutController::class, 'complete'])->name('user.order.complete');
        Route::post('/notification', [CheckoutController::class, 'notificationHandler'])->name('notification.handler');
        Route::post('/save-transaction', [CheckoutController::class, 'saveTransaction'])->name('user.save.transaction');

        Route::post('/order/cancel', [CheckoutController::class, 'cancel'])->name('user.order.cancel');
    });
