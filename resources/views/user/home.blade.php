            ...
            <div class="row">
                    ...
                    <div class="hero-slider">
                        <div class="hero-slider-main owl-carousel dots-inside">
                            @foreach ($sliders as $slider)
                                <div class="item" style="background: url('{{ asset('uploads/slider') }}/{{ $slider->image }}')">
                ...
                <div class="col-lg-4 d-none d-lg-block">
                    <a href="#" class="sright-image">
                        <img src="{{ asset('uploads/home_page') }}/{{ $home_page_value->image1 }}" alt="">
                    ...
                    <a href="#" class="sright-image">
                        <img src="{{ asset('uploads/home_page') }}/{{ $home_page_value->image2 }}" alt="">
                        <div class="inner-content">
                ...
                @foreach ($services as $service)
                    <div class="col-lg-3 col-sm-6 text-center mb-30">
                        <div class="single-service single-service2">
                            <img src="{{ asset('uploads/service') }}/{{ $service->image }}" alt="Shipping">
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        <img class="lazy"
                                            data-src="{{ asset('uploads/product/' . $product->featured_image) }}"
                                            alt="Product">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <h4 class="product-price">
                                            <del>{{ format_rupiah($product->previous_price) }}</del>

                                            {{ format_rupiah($product->current_price) }}
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <h4 class="product-price">
                                            <del>Rp.{{ $product->previous_price }}</del>

                                            Rp.{{ $product->current_price }}
                                        </h4>
                                    </div>
                                </div>
                            </div>
