                    ...
                    <div class="product-thumbnails insize">
                        <div class="">
                            <div class="item" style="position: relative; overflow: hidden;">
                                <img src="{{ asset('uploads/product/' . $product->featured_image) }}" alt="zoom">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-page-top-right-content d-flex align-items-center">
                    <div class="div w-100">
                        ...
                        <span class="h3 d-block price-area">
                            <small class="d-inline-block"><del>{{ format_rupiah($product->previous_price) }}</del></small>
                            <span id="main_price" class="main-price">{{ format_rupiah($product->current_price) }}</span>
                        </span>
                        ...
                        <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                    <img class="lazy"
                                        data-src="{{ asset('uploads/product/' . $product1->featured_image) }}"
                                        alt="Product">
                                ...
                                <div class="product-card-body">
                                    ...
                                    <h4 class="product-price">
                                        <del>{{ format_rupiah($product1->previous_price) }}</del>

                                        {{ format_rupiah($product1->current_price) }}
                                    </h4>
                                </div>
                            </div>
                        </div>
