<div class="col-lg-4">
    <aside class="user-info-wrapper">
        ...
        <nav class="list-group">
            <a class="list-group-item {{ Request::routeIs('user.dashboard') ? 'active' : '' }}" href="{{ route('user.dashboard') }}">
                <i class="icon-command"></i> Dashboard
            </a>
            <a class="list-group-item {{ Request::routeIs('user.dashboard.profile') ? 'active' : '' }}" href="{{ route('user.dashboard.profile') }}">
            ...
            <a class="list-group-item {{ Request::routeIs('user.dashboard.address') ? 'active' : '' }}" href="{{ route('user.dashboard.address') }}">
