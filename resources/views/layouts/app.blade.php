...
<head>
    ...
    <!-- Favicon Icons-->
    <link rel="icon" type="image/png" href="{{ asset($setting_value->favicon) }}">
    <link rel="apple-touch-icon" href="{{ asset($setting_value->favicon)}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset($setting_value->favicon)}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset($setting_value->favicon)}}">
    <link rel="apple-touch-icon" sizes="167x167" href="{{ asset($setting_value->favicon)}}">
                                    ...
                                    <div class="toolbar-dropdown cart-dropdown widget-cart  cart_view_header"
                                            ...
                                            <div class="entry">
                                                ...
                                                <div class="entry-content">
                                                    ...
                                                    <span class="entry-meta">{{ $cart->qty }} x
                                                        {{ format_rupiah($cart->sub_total) }}</span>
                                        ...
                                        <div class="text-right">
                                            <p class="text-gray-dark py-2 mb-0"><span
                                                    class="text-muted">Subtotal:</span>{{ format_rupiah($sub_total) }}</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                ...
                                @foreach ($categories1 as $category)
                                    <div class="c-item">
                                        <a class="d-block navi-link"
                                            ...
                                            <img class="lazy"
                                                data-src="{{ asset('uploads/category') }}/{{ $category->image }}">
