                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-0 pt-0 mt-0 mb-0">
                                        ...
                                        <img class="admin-img lg" src="{{ asset('uploads/placeholder.jpg') }}" id="preview-image">
                                        @else
                                        <img class="admin-img lg" src="{{ asset('uploads/product/' . $product->featured_image) }}" id="preview-image">
                                        @endif
                                    </div>
