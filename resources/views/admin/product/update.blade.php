    ...
    <div class="content">
        <div class="page-inner">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-0 bc-title"><b>Update Product</b> </h3>
                ...
                <form class="admin-form tab-form" action="{{ route('admin.product.update',['id'=>$product->id]) }}" method="POST"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group pb-0 pt-0 mt-0 mb-0">
                                        <img class="admin-img lg" src="{{ asset('uploads/product/' . $product->featured_image) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="current_price" name="current_price"
                                                ...
                                                step="0.1" value="{{ format_rupiah($product->current_price) }}">
                                            @error('current_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="previous_price" name="previous_price"
                                                ...
                                                step="0.1" value="{{ format_rupiah($product->previous_price) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sub_cat_id" id="subcategory_id"
                                            ...
                                            @foreach ($subchilds as $subchild)
                                                <option value="{{ $subchild->id }}" @selected($product->sub_cat_id == $subchild->id)>{{ $subchild->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('sub_cat_id')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="child_cat_id" id="childcategory_id" class="form-control">
                                            ...
                                            @foreach ($childs as $child)
                                                <option value="{{ $child->id }}" @selected($product->child_cat_id == $child->id)>{{ $child->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('cat_id')
                                            <span class="text-danger">{{ $message }}</span>
