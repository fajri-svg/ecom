                                                        ...
                                                        <div id="herosectionbanner" class="tab-pane"><br>
                                                            <form action="{{ route('admin.manage-site.home_page') }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
                                                                    <img class="admin-img"
                                                                        src="{{ asset($home_page_value->image1) }}"
                                                                        alt="No Image Found">
                                                                    <br>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
                                                                    <img class="admin-img"
                                                                        src="{{ asset($home_page_value->image2) }}"
                                                                        alt="No Image Found">
                                                                    <br>
                                                                    <span class="mt-1">Image Size Should Be 496 x
                                                                        204.</span>
                                                        ...
                                                        <div id="ftc" class="tab-pane"><br>
                                                            <form
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
                                                                    <img class="admin-img"
                                                                        src="{{ asset($first_three_column_value->image1) }}"
                                                                        alt="No Image Found">
                                                                    <br>
                                                                    <span class="mt-1">Image Size Should Be 496 x
                                                                        204.</span>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
                                                                    <img class="admin-img"
                                                                        src="{{ asset($first_three_column_value->image2) }}"
                                                                        alt="No Image Found">
                                                                    <br>
                                                                    <span class="mt-1">Image Size Should Be 496 x
                                                                        204.</span>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
                                                                    <img class="admin-img"
                                                                        src="{{ asset($first_three_column_value->image3) }}"
                                                                        alt="No Image Found">
                                                                    <br>
                                                                    <span class="mt-1">Image Size Should Be 496 x
                                                                        204.</span>
