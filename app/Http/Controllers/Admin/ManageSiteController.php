...
class ManageSiteController extends Controller
{
    ...
    function home_page(Request $request)
    {
        ...
        if ($request->hasFile('image1')) {
            ...
            $originalFilename1 = $request->file('image1')->getClientOriginalName();

            // Menambahkan timestamp untuk menghindari nama file yang sama
            $newFilename1 = time() . '_' . $originalFilename1;

            // Menyimpan file dengan nama file asli di folder 'home_page' di dalam disk 'public'
            $request->file('image1')->storeAs('home_page', $newFilename1, 'public');
        ...
        if ($request->hasFile('image2')) {
            // Mendapatkan nama file asli
            $originalFilename2 = $request->file('image2')->getClientOriginalName();

            // Menambahkan timestamp untuk menghindari nama file yang sama
            $newFilename2 = time() . '_' . $originalFilename2;

            // Menyimpan file dengan nama file asli di folder 'home_page' di dalam disk 'public'
            $request->file('image2')->storeAs('home_page', $newFilename2, 'public');
